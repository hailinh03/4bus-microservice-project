...
public class SecurityConfig {
    ...
    private static final List<Map.Entry<String, HttpMethod>> SECURED_URLS = List.of(
            Map.entry("/trips", HttpMethod.POST),
            Map.entry("/route-points", HttpMethod.POST),
            Map.entry("/route-points/*", HttpMethod.PUT),
            Map.entry("/route-points/*", HttpMethod.DELETE),
            Map.entry("/trips/*", HttpMethod.PUT),
            Map.entry("/trips/*", HttpMethod.DELETE));
