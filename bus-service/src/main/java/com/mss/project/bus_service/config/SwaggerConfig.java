...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Bus Services API for 4Bus Microservices", version = "1.0", description = "API for Bus Services in 4Bus Microservices application", contact = @Contact(name = "4Bus Team", email = "4bus@gmail.com")), servers = {
                @Server(url = "https://bus.4bus.io.vn", description = "Production Server"),
